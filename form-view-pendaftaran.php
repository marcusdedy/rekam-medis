...
?>
    ...
    <h6><font color="orange" size="5"><u>Patient Registration</u></font>       <u>
    <left></left>
    </u></h6>
<form action="home-user.php?page=form-view-pendaftaran" method="post" name="postform">
...
<tr>
  <td align="center" >&nbsp;</td>
    ...
    onclick="window.open('form-pendaftaran.php','nama_window_pop_up','height = 600, width = 950, resizable = 0')">++ Registration </a></td>
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>	Data yang ditampilkan adalah pasien yang sudah mendaftar tetapi belum periksa.</p>
</form>
<p>
  <?php
...
<table width="1206" border="0" align="center" cellpadding="0" cellspacing="1">
	<tr bgcolor="#0066FF">
		<th width="3%"><font color="#FFFFFF"> No. </font></td>&nbsp;
      	...
      	<th width="13%"><font color="#FFFFFF"> Dokter </font>
    ...
    onclick="window.open('form-edit-pendaftaran.php?pr_patien_id=<?php echo $pr_patien_id; ?>','nama_window_pop_up','height = 600, width = 950, resizable = 0')">Edit</a>
        || <a href="home-user.php?page=proses-hapus-pendaftaran&pr_patien_id=<?=$pr_patien_id?>">Hapus</a></div></td>
    </tr>
    <tr>
