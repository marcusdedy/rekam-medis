...
<table width="1250" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
        ...
        <img src="image/home-head.png" width="600" height="110" />
        </td>
  </tr>
</table>
<table width="1250" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="1228" height="auto" bgcolor="white" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="938" align="center" valign="top">
						...
						switch ($page) {
							case 'login' : include "login-user/login.php"; break;
							case 'main' :
...
<div class="popup-wrapper" id="popup">
    ...
    <form action="login-user/login.php" method="post" class="popup-form">
			<font color="#0000FF"><h2>Login Your Authorization:</h2></font>
			<div class="input-group">
			<input type="text" name="mu_username" placeholder=" Username" required autofocus size="21" maxlength="20" /><br />
			<input type="password" name="mu_password" placeholder=" Password" size="21" maxlength="20" /><br /><br />
